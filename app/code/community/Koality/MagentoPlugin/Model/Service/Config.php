...
class Koality_MagentoPlugin_Model_Service_Config
{
    ...
    public const RUSHHOUR_BEGIN = 'koality_service/rush_hour/rushHourBegin';

    public const RUSHHOUR_END = 'koality_service/rush_hour/rushHourEnd';

    public const MIN_EXPECTED_ORDERS_PER_RUSHHOUR = 'koality_service/rush_hour/minOrdersPerHourRushHour';

    public const RUSHHOUR_INCLUDES_WEEKENDS = 'koality_service/rush_hour/includeWeekends';

    public const MIN_EXPECTED_ORDERS_PER_HOUR_NORMAL = 'koality_service/opening_hours/minOrdersPerHourNormal';

    public const MAX_EXPECTED_OPEN_CARTS = 'koality_service/open_carts/maxOpenCarts';

    public const MIN_EXPECTED_ACTIVE_PRODUCTS = 'koality_service/active_products/activeProducts';
